...
const HomeThree = () => {
  return (
   ...
   <div className='home-three'>
    <p>Tailored </p>
    <p className='three-topic'><hr /><p>Web Solutions</p></p>
...
<div className='mobile'>Mobile Development <MdArrowOutward /> </div>
   <div className="ecommerce">
E-commerce Solutions <MdArrowOutward />
   </div>
   <div className="crm">CRM Solutions <MdArrowOutward /> </div>
   <div className="logistics">Logistics Solutions <MdArrowOutward /> </div>
